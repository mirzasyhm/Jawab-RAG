# llm_only_baseline/config.py

# LLM Configuration
QWEN_MODEL_NAME = "Qwen/Qwen3-8B" # Or your chosen LLM

# Surah name to number mapping (needed for generating formatted answers if LLM recalls verses)
SURAH_NAME_TO_NO = {
    ...
    "al-anbiya": 21, "al-hajj": 22, "al-mum'inun": 23, "an-nur": 24,
...
EVAL_CSV_FILENAME = "evaluation_data_baseline.csv" # Local filename for the downloaded eval data
RAGAS_RESULTS_BASELINE_FILENAME = 'ragas_evaluation_results_llm_only_baseline.csv'

# Option for baseline: whether to preprocess query with LLM before generating answer
PREPROCESS_QUERY_FOR_BASELINE = True
